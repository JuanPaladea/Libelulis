...
const ProductosDestacadosComponent = () => {
  return (
      ...
      <div class="container px-4 py-24 mx-auto max-w-7xl">
        <div class="flex flex-col">
          ...
          <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
            <h1 class="sm:w-2/5 text-gray-900 text-3xl tracking-tight font-extrabold mb-2 sm:mb-0">Productos destacados</h1>
          </div>
        </div>
...
export default ProductosDestacadosComponent