...
const LoginWithGoogleComponent = () => {
  ...
  return (
    <button onClick={handleSignWithGoogle} class="w-full flex justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-1.5 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
