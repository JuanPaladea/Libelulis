...
const OrderSummary = () => {
  ...
  return (
    <section class="flex items-center py-16 px-4 max-w-7xl mx-auto">
        <div class="justify-center flex-1 bg-white border rounded-md py-6">
            <div>
                ...
                Gracias. Tu orden fue recibida. </h1>
                <div class="flex border-b border-gray-200 items-stretch justify-start w-full h-full px-4 mb-8 md:flex-row xl:flex-col md:space-x-6 lg:space-x-8 xl:space-x-0">
                    <div class="flex items-start justify-start flex-shrink-0">
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <img src={user?.photoURL} class="object-cover w-16 h-16 rounded-md" alt="avatar"/>
                            <div class="flex flex-col items-start justify-start space-y-2">
                                <p class="text-lg font-semibold leading-4 text-left text-gray-800">
                                {user?.displayName || ' '}</p>
                                <p class="text-sm leading-4 cursor-pointer">{user?.email}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col items-stretch justify-center w-full space-y-4 md:flex-row md:space-y-0 md:space-x-8">
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <p class="text-base font-semibold leading-4 text-gray-600">Rs.700</p>
                            </div>
                        </div>
                        <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                            ...
                            <div class="flex items-start justify-between w-full">
                                ...
                                <p class="text-lg font-semibold leading-6 text-gray-800">Rs.50</p>
                            </div>
                        </div>
                    </div>
                </div>
